...
class CategoryGoodsViewModel : BaseViewModel() {
    ...
    private fun getGoodsOrderByCategory(): MutableLiveData<ArrayList<ArrayList<GoodsDummy>>> {
        ...
        dummyGoods.add(GoodsDummy(5, "http://res.heraldm.com/phpwas/restmb_idxmake.php?idx=507&simg=/content/image/2017/02/272017022700018_0.jp", "현미", 7000, 3000, "메로나 마트"))
