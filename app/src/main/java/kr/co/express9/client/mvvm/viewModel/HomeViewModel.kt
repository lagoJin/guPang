...
class HomeViewModel : BaseViewModel() {
    ...
    private val _goods = MutableLiveData<ArrayList<CategoryGoodsViewModel.GoodsDummy>>()
    val goods: LiveData<ArrayList<CategoryGoodsViewModel.GoodsDummy>>
        get() = _goods

    fun getGoods() {
        val dummyGoods = ArrayList<CategoryGoodsViewModel.GoodsDummy>()
        dummyGoods.add(
            CategoryGoodsViewModel.GoodsDummy(
                0,
